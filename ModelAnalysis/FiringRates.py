...
layer_idx = [25]#, 34]#, 37]#34, 37]#, 25, 34]
#conds = ['neutral', 'P-0_I-0_O-0.3','P-1_I-0_O-0.3','P-1_I-0_O-0', 'P-0_I-0.15_O-0', 'P-1_I-0.15_O-0']# 'P-1_I-0.15' 'P-1_I-0_O-0'] # Todo
#conds = ['P-0_I-0.05_O-0.2', 'P-1_I-0.05_O-0.2']
conds = ['P-0_I-0.15_O-0', 'P-1_I-0.15_O-0', 'P-0_I-0.05_O-0.2', 'P-1_I-0.05_O-0.2']# 'P-1_I-0.15' 'P-1_I-0_O-0']
#conds = ['P-1_I-0_O-0.3','P-1_I-0_O-0', 'P-0_I-0.15_O-0', 'P-1_I-0.15_O-0', 'P-0_I-0.05_O-0.2', 'P-1_I-0.05_O-0.2']#
    ...
    for l in layer_idx:
        ...
        if cond == 'neutral':
            ...
            if compute_dataset == True:
                ...
                mua = np.full((len(x_train), time_steps), np.nan)
                mua_all = np.full((len(x_train), time_steps), np.nan)
